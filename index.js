...
// ANSWER: Time complexity is already O(1) so no it can not be improved. But this is simpler, but with same time complexity
// const findFourth = numbers => numbers[3]
...
// ANSWER: No. But this is a bit simpler, albeit with same space complexity. 
...
// ANSWER: yes, same space complexity. 
...
// ANSWER: Both functions scale proportionately to the size of the input string. Both strings will take up 2 bytes per character, scaling by string size. 2*n. Letters object will also scale proportionately
